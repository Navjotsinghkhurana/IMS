                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="File" placeholder="Phone No" name="file" required class="form-control" >
                                                </div>
                                            </div>
...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
        	...
        	$sqlInsert="INSERT INTO st_excel (id, roll_no, Registration_no, Student_Name, Father_Name) VALUES (NULL, '$column[1]', '$column[2]', '$column[3]', '$column[4]')";
