...
function getlist(){
      var clas = document.getElementById("clas").value;  
       ...
       var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("GET", "AJAX/getstudents.php?clas="+clas, true);
        xmlhttp.send();
}
...
<div class="col-md-4">
    ...
    <select class="select-style Type" name="Department" onclick="getlist();" required id="clas" onselect="getlist();">
            ...
            while ($GetClass_Fetch=mysqli_fetch_array($GetClass_query)) {
             ...
             echo '<option value="'.$Class_id.'">Section '.$section.' -'.$semester.' Semester</option>';
    ...
    <input class="select-style Type" name="regestration_no" required id="sem"   >  
...
<div class="col-md-4">
  <h5>  </h5>
  <button type="button" name="entbtn" class="btn btn-success" onclick="getlist();">Go</button>
